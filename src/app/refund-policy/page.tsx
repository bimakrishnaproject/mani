          ...
          >
            <div className="p-8 bg-soft-white border-2 border-mist-grey rounded-3xl space-y-4 shadow-md">
              ...
              <p className="text-sm text-[#1C2826]">
                We stand fully behind the transformational quality of MANI&trade; Collections. If any collection or individual tool does not provide you with immediate emotional clarity and practical boundary tools, you may request a 100% refund within 30 days of purchase.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p>
                All digital PDFs and instant download products included in MANI&trade; bundles are covered under our 30-Day Refund Guarantee. If you are unsatisfied with your digital access, contact support within 30 days for a complete refund.
              </p>
            </div>
