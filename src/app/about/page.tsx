      ...
      <main className="flex-grow pt-36 md:pt-48 pb-32">
        ...
        <section className="px-6 sm:px-12 md:px-16 lg:px-24 mb-24">
          <motion.div {...fadeIn} className="max-w-4xl space-y-6">
            ...
            <p className="text-lg sm:text-xl text-[#4A524D] font-light leading-relaxed">
              MANI&trade; was created to make emotional support simple, accessible and practical for everyday life.
            </p>
          </motion.div>
        </section>
        ...
        <section className="px-6 sm:px-12 md:px-16 lg:px-24 mb-24">
          <motion.div {...fadeIn} className="mb-12">
            <span className="text-xs font-bold tracking-widest uppercase text-[#0E2E1E]/60 block mb-2">
              OUR FOUNDER
            </span>
          ...
          {founders.map((founder, idx) => (
            ...
            >
              ...
              <div className="lg:col-span-7 space-y-6">
                <div>
                  <span className="text-xs font-bold text-[#0E2E1E]/60 uppercase tracking-widest block mb-1">
                    {founder.role}
                  </span>
        ...
        <section className="px-6 sm:px-12 md:px-16 lg:px-24 mb-24">
          <motion.div {...fadeIn} className="mb-12">
            ...
            <h2 className="font-serif-heading text-4xl sm:text-5xl text-[#0E2E1E]">
              The People Behind MANI&trade;
            </h2>
            <p className="text-base text-[#4A524D] font-light leading-relaxed mt-4 max-w-2xl">
              The people behind MANI&trade; bring decades of experience, specialized expertise, and a shared commitment to excellence because we believe the quality of what we create depends on the quality of the people who create it.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl">
            {howWeCreate.map((item, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.7, delay: idx * 0.08, ease: [0.16, 1, 0.3, 1] }}
                className="p-6 bg-[#0E2E1E] text-editorial-white rounded-2xl space-y-3 shadow-md"
              >
                <span className="text-3xl font-serif-heading text-cream-logo/30 block">
                  {item.step}
                </span>
                <h3 className="font-serif-heading text-xl text-cream-logo">{item.title}</h3>
                <p className="text-xs text-editorial-white/80 font-light leading-relaxed">
                  {item.desc}
                </p>
              </motion.div>
            ))}
